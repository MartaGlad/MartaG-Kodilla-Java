...
public class Checkers {
    ...
    public static class CheckersBuilder {
        ...
        public CheckersBuilder Figure(String figureType, String figureColor, int x, int y) {
            if(x < Board.MIN_INDEX || x > Board.MAX_INDEX || y < Board.MIN_INDEX || y > Board.MAX_INDEX) {
        ...
        public Checkers build() {
            ...
            if(!(white && black)) { //czy na planszy znajduje się co najmniej po jednej figurze z każdego koloru
