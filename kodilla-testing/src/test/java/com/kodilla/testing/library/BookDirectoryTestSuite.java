...
public class BookDirectoryTestSuite {
    ...
    private List<Book> generateListOfNBooks(int booksQuantity) {
        ...
        for (int n = 1; n <= booksQuantity; n++) {
            Book theBook = new Book("Ttle " + n, "Author " + n, 1970 + n);
    ...
    class TestsListBooksInHandsOf {
        @Test
        void testListBooksInHandsOfWhen0() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            List<Book> resultListOf0Books = new ArrayList<>();
            LibraryUser libraryUser= new LibraryUser("f", "l", "p");
        ...
        @Test
        void testListBooksInHandsOfWhen1() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        @Test
        void testListBooksInHandsOfWhen5() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
