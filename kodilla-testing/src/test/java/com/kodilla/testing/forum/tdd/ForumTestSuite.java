...
public class ForumTestSuite {
    ...
    class TestPosts {
        ...
        void testGetPost(){
            //Given
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("mrsmith","Hello everyone, this is my first contribution here!");
    ...
    class TestComments {
        ...
        void testAddComment(){
            ...
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here!","mrsmith");
            //When
            forumUser.addComment("mrsmith", "Thank you for all good words!",thePost);
            //Then
        ...
        void testGetComment() {
            ...
            ForumUser forumUser = new ForumUser("mrsmith", "John Smith");
            ForumPost thePost = new ForumPost("Hello everyone, this is my first contribution here!", "mrsmith");
            ForumComment theComment = new ForumComment("mrsmith", "Thank you for all good words!", thePost);

            forumUser.addComment(theComment.getAuthor(),theComment.getCommentBody(),thePost);
            //When
